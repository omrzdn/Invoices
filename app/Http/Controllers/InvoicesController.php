...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Notification::send($user, new new_invoice($invoices));
    ...
    public function Print_invoice($id)
    {
        ...
        $data = 'https://localhost/Invoices/public/Print_invoice/'.$id;

        
        $qrcode = (new QRCode($options))->render($data);

        return view('invoices.Print_invoice',compact('invoices', 'qrcode'));
    }
